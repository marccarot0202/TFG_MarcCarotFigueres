...
import type { CreateInterface, GetInterface } from "../interface/index.cjs";
import type { ExecuteSnapAction, ExecutionServiceEvents, HandleRpcRequestAction, SnapErrorJson, TerminateSnapAction } from "../services/index.cjs";
import type { ExportableKeyEncryptor } from "../types/index.cjs";
...
export declare class SnapController extends BaseController<typeof controllerName, SnapControllerState, SnapControllerMessenger> {
    #private;
    ...
    _onUnhandledSnapError(snapId: string, error: SnapErrorJson): void;
     ...
     * stopped.
     */
    stopAllSnaps(statusEvent?: SnapStatusEvents.Stop | SnapStatusEvents.Crash): Promise<void>;
    /**
...
export {};
//# sourceMappingURL=SnapController.d.cts.map