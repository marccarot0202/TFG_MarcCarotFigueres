...
export class Timer {
     ...
     */
    cancel() {
        assert(this.status === 'paused' || this.status === 'running', 'Tried to cancel a not running Timer');
        this.onFinish(false);
    }
    /**
     ...
     */
    pause() {
        assert(this.state.value === 'running', 'Tried to pause a not running Timer');
     ...
     */
    start(callback) {
        assert(this.state.value === 'stopped', 'Tried to start an already running Timer');
