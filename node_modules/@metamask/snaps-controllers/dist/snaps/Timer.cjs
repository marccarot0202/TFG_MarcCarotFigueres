...
class Timer {
     ...
     */
    cancel() {
        (0, utils_1.assert)(this.status === 'paused' || this.status === 'running', 'Tried to cancel a not running Timer');
        this.onFinish(false);
    }
    /**
     ...
     */
    finish() {
        (0, utils_1.assert)(this.status !== 'finished', 'Tried to finish a finished Timer.');
        this.onFinish(true);
    }
    /**
     ...
     */
    pause() {
        (0, utils_1.assert)(this.state.value === 'running', 'Tried to pause a not running Timer');
     ...
     */
    start(callback) {
        (0, utils_1.assert)(this.state.value === 'stopped', 'Tried to start an already running Timer');
     ...
     */
    resume() {
        (0, utils_1.assert)(this.state.value === 'paused', 'Tried to resume not paused Timer');
