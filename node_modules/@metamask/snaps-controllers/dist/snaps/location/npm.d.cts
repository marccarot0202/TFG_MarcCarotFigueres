...
import type { DetectSnapLocationOptions, SnapLocation } from "./location.cjs";
export declare const DEFAULT_NPM_REGISTRY: URL;
export declare const NPM_REGISTRY_PROXY: URL;
type NpmMeta = {
    registry: URL;
    packageName: string;
...
export declare class NpmLocation extends BaseNpmLocation {
     ...
     * @throws If fetching the tarball fails.
     */
    fetchNpmTarball(tarballUrl: URL): Promise<Map<string, VirtualFile>>;
}
