 ...
 */
export declare function getCronjobSpecificationSchedule(specification: CronjobSpecification): string;
/**
 ...
 */
export declare function getExecutionDate(schedule: string): string;
