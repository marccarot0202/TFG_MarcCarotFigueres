...
import type { SnapLocation } from "./snaps/index.mjs";
 ...
 */
export declare function debouncePersistState(fn: (snapId: SnapId, newSnapState: Record<string, Json> | null, encrypted: boolean) => void, timeout?: number): (snapId: SnapId, newSnapState: Record<string, Json> | null, encrypted: boolean) => void;
/**
 * Handlers allowed for tracking.
 */
export declare const TRACKABLE_HANDLERS: readonly [HandlerType.OnHomePage, HandlerType.OnInstall, HandlerType.OnNameLookup, HandlerType.OnRpcRequest, HandlerType.OnSignature, HandlerType.OnTransaction, HandlerType.OnUpdate];
/**
 ...
 */
export declare function throttleTracking(fn: (snapId: SnapId, handler: TrackableHandler, success: boolean, origin: string) => void, timeout?: number): (snapId: SnapId, handler: TrackableHandler, success: boolean, origin: string) => void;
/**
 ...
 */
export declare function isTrackableHandler(handler: HandlerType): handler is TrackableHandler;
/**
 ...
 */
export declare function isLocalSnapId(snapId: SnapId): boolean;
export {};
