...
export class BrowserRuntimePostMessageStream extends BasePostMessageStream {
    ...
    _onMessage(message) {
        if (!isValidStreamMessage(message) || message.target !== __classPrivateFieldGet(this, _BrowserRuntimePostMessageStream_name, "f")) {
            return;
        }
...
//# sourceMappingURL=BrowserRuntimePostMessageStream.mjs.map