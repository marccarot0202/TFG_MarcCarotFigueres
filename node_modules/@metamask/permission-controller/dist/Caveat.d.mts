...
import type { AsyncRestrictedMethod, RestrictedMethod, PermissionConstraint, RestrictedMethodParameters } from "./Permission.mjs";
 ...
 */
export type CaveatValueMerger<Value extends Json> = (leftValue: Value, rightValue: Value) => [Value, Value] | [];
...
export {};
//# sourceMappingURL=Caveat.d.mts.map