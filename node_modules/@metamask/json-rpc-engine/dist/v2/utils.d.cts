...
export declare const isRequest: <Params extends JsonRpcParams>(message: JsonRpcCall<Params> | Readonly<JsonRpcCall<Params>>) => message is JsonRpcRequest<Params>;
export declare const isNotification: <Params extends JsonRpcParams>(message: JsonRpcCall<Params>) => message is JsonRpcNotification<Params>;
/**
