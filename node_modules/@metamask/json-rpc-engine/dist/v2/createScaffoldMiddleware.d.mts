...
import type { ContextConstraint, MiddlewareContext } from "./MiddlewareContext.mjs";
 ...
 */
export type MiddlewareScaffold<Context extends ContextConstraint = MiddlewareContext> = Record<string, ScaffoldMiddlewareHandler<JsonRpcParams, Json, Context>>;
/**
