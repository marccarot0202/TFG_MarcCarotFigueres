...
export declare const ButtonClickEventStruct: import("@metamask/superstruct").Struct<{
    ...
    type: import("@metamask/superstruct").Struct<UserInputEventType.ButtonClickEvent, null>;
    name: import("@metamask/superstruct").Struct<string | undefined, null>;
}>;
/**
...
export declare const AccountSelectorStateStruct: import("@metamask/superstruct").Struct<{
    addresses: `${string}:${string}:${string}`[];
    accountId: string;
}, {
    accountId: import("@metamask/superstruct").Struct<string, null>;
    addresses: import("@metamask/superstruct").Struct<`${string}:${string}:${string}`[], import("@metamask/superstruct").Struct<`${string}:${string}:${string}`, null>>;
}>;
/**
...
export declare const FileUploadEventStruct: import("@metamask/superstruct").Struct<{
    ...
    type: import("@metamask/superstruct").Struct<UserInputEventType.FileUploadEvent, null>;
    name: import("@metamask/superstruct").Struct<string, null>;
...
//# sourceMappingURL=user-input.d.mts.map