...
export declare const OnAssetsMarketDataRequestArgumentsStruct: Struct<{
    ...
    assets: Struct<{
        ...
        asset: Struct<`${string}:${string}/${string}:${string}` | `${string}:${string}/${string}:${string}/${string}`, null>;
...
export declare const OnAssetsLookupRequestArgumentsStruct: Struct<{
    assets: (`${string}:${string}/${string}:${string}` | `${string}:${string}/${string}:${string}/${string}`)[];
}, {
    assets: Struct<(`${string}:${string}/${string}:${string}` | `${string}:${string}/${string}:${string}/${string}`)[], Struct<`${string}:${string}/${string}:${string}` | `${string}:${string}/${string}:${string}/${string}`, null>>;
}>;
