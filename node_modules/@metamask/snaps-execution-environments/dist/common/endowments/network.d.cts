 ...
 */
export declare class ResponseWrapper implements Response {
    #private;
    constructor(ogResponse: Response, teardownRef: {
        lastTeardown: number;
    }, onStart: () => Promise<void>, onFinish: () => Promise<void>);
...
declare class AlteredResponse extends Response {
...
declare const endowmentModule: {
    ...
    factory: ({ notify }?: EndowmentFactoryOptions) => {
        ...
        Response: typeof AlteredResponse;
