...
import type { InternalAccount } from "./account.cjs";
 ...
 */
export declare function validateAssetSelector(address: CaipAccountId, getAccountByAddress: (address: CaipAccountId) => InternalAccount | undefined): void;
/**
 ...
 */
export declare function validateJsxElements(node: JSXElement, { isOnPhishingList, getSnap, getAccountByAddress, hasPermission, }: {
