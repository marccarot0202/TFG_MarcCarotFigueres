...
import { MAX_FILE_SIZE } from "./constants.mjs";
/**
 ...
 */
export function validateAuxiliaryFiles(files) {
    for (const file of files) {
        assert(file.size < MAX_FILE_SIZE, 'Static files required by the Snap must be smaller than 64 MB.');
    }
}
