...
export declare const ProtocolScopesStruct: Struct<Record<`${string}:${string}`, {
    methods: string[];
}>, null>;
...
export declare const SnapAuxiliaryFilesStruct: Struct<string[], Struct<string, null>>;
/**
...
export declare const SnapManifestStruct: Struct<{
    ...
    platformVersion: Struct<import("@metamask/utils").SemVerVersion | undefined, null>;
