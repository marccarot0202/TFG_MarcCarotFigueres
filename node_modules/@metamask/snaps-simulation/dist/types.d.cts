...
import type { CaipChainId, Json, JsonRpcId, JsonRpcParams, JsonRpcRequest } from "@metamask/utils";
import type { NameLookupOptionsStruct, SignatureOptionsStruct, SnapOptionsStruct, SnapResponseStruct, TransactionOptionsStruct } from "./structs.cjs";
 ...
 */
export type JsonRpcMockImplementation = (request: JsonRpcRequest) => Promise<Json> | Json | undefined;
/**
...
export type Snap = {
     ...
     * @returns The response.
     */
    onNameLookup(nameLookupRequest: NameLookupOptions): Promise<SnapResponseWithoutInterface>;
    /**
