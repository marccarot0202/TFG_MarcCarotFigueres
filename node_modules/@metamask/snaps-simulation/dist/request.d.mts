 ...
 */
export declare function handleRequest({ snapId, store, executionService, handler, controllerMessenger, simulationOptions, runSaga, request: { id, origin, ...options }, }: HandleRequestOptions): SnapRequest;
/**
 ...
 */
export declare function getInterfaceApi(result: unknown, snapId: SnapId, controllerMessenger: RootControllerMessenger, options: SimulationOptions, contentId?: string): Promise<(() => SnapHandlerInterface) | undefined>;
