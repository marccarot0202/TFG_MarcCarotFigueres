...
const VerifiedSnapVersionStruct = (0, superstruct_1.object)({
    ...
    clientVersions: (0, superstruct_1.optional)((0, superstruct_1.object)({
        extension: (0, superstruct_1.optional)(utils_1.VersionRangeStruct),
        mobile: (0, superstruct_1.optional)(utils_1.VersionRangeStruct),
    })),
});
