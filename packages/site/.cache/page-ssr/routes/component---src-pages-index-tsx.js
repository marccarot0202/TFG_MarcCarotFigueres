...
const StatusCard = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].div.withConfig({
  ...
  return (_theme$colors$backgro2 = theme.colors.background) === null || _theme$colors$backgro2 === void 0 ? void 0 : _theme$colors$backgro2.alternative;
}, ({
  theme
}) => {
...
const StatusHeader = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].div.withConfig({
  displayName: "pages__StatusHeader"
})(["display:flex;align-items:center;gap:0.8rem;font-weight:700;margin-bottom:0.8rem;"]);
const StatusDot = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].span.withConfig({
...
const SmallButton = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].button.withConfig({
  ...
  return (_theme$colors$backgro3 = theme.colors.background) === null || _theme$colors$backgro3 === void 0 ? void 0 : _theme$colors$backgro3.alternative;
}, ({
  theme
}) => {
...
const TableWrapper = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].div.withConfig({
  ...
  var _theme$colors$backgro4;
  return (_theme$colors$backgro4 = theme.colors.background) === null || _theme$colors$backgro4 === void 0 ? void 0 : _theme$colors$backgro4.alternative;
}, ({
  theme
}) => {
...
const TableHead = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].thead.withConfig({
  ...
  var _theme$colors$backgro5;
  return (_theme$colors$backgro5 = theme.colors.background) === null || _theme$colors$backgro5 === void 0 ? void 0 : _theme$colors$backgro5.default;
});
...
const RiskBadge = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].span.withConfig({
  displayName: "pages__RiskBadge"
...
const StatCard = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].div.withConfig({
  ...
  return (_theme$colors$backgro6 = theme.colors.background) === null || _theme$colors$backgro6 === void 0 ? void 0 : _theme$colors$backgro6.alternative;
}, ({
  theme
}) => {
...
const SearchInput = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].input.withConfig({
  ...
  var _theme$colors$backgro7;
  return (_theme$colors$backgro7 = theme.colors.background) === null || _theme$colors$backgro7 === void 0 ? void 0 : _theme$colors$backgro7.alternative;
}, ({
  theme
}) => {
...
const SelectInput = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].select.withConfig({
  ...
  var _theme$colors$backgro8;
  return (_theme$colors$backgro8 = theme.colors.background) === null || _theme$colors$backgro8 === void 0 ? void 0 : _theme$colors$backgro8.alternative;
}, ({
  theme
}) => {
...
const ChartCard = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].div.withConfig({
  displayName: "pages__ChartCard"
})(["background-color:", ";border:1px solid ", ";border-radius:", ";padding:1.6rem;"], ({
  theme
}) => {
  var _theme$colors$backgro9;
  return (_theme$colors$backgro9 = theme.colors.background) === null || _theme$colors$backgro9 === void 0 ? void 0 : _theme$colors$backgro9.alternative;
}, ({
  theme
}) => {
...
const BarHeader = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].div.withConfig({
  displayName: "pages__BarHeader"
})(["display:flex;justify-content:space-between;gap:1.2rem;margin-bottom:0.4rem;font-size:", ";"], ({
  theme
}) => theme.fontSizes.small);
const BarTrack = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].div.withConfig({
  ...
  return (_theme$colors$backgro10 = theme.colors.background) === null || _theme$colors$backgro10 === void 0 ? void 0 : _theme$colors$backgro10.default;
});
...
const Index = () => {
  ...
  const {
    0: knownAddressesError,
    1: setKnownAddressesError
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null);
  const {
    0: isLoadingKnownAddresses,
    1: setIsLoadingKnownAddresses
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  const {
    0: knownAddressSearch,
    1: setKnownAddressSearch
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('');
  const {
    0: knownAddressType,
    1: setKnownAddressType
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('all');
  const {
    0: manualAddress,
    1: setManualAddress
  ...
  const {
    0: manualType,
    1: setManualType
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('warning');
  const {
    0: manualReportMessage,
    1: setManualReportMessage
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null);
  const {
    0: manualReportSuccess,
    1: setManualReportSuccess
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  const {
    0: isSubmittingManualReport,
    1: setIsSubmittingManualReport
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  const {
    0: dashboardMetrics,
    1: setDashboardMetrics
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null);
  const {
    0: dashboardMetricsError,
    1: setDashboardMetricsError
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null);
  const {
  ...
  const loadKnownAddresses = async () => {
    try {
      ...
      const response = await fetch(`http://localhost:3000/known-addresses?${params.toString()}`);
      const data = await response.json();
      if (!data.success) {
  ...
  const renderStatusCard = (title, service, fallbackMessage = 'Sense informació') => {
    ...
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(StatusCard, {
      ...
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(StatusMessage, {
        children: message
      })]
    });
  };
  const renderStatCard = (label, value) => {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(StatCard, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(StatValue, {
        children: value !== null && value !== void 0 ? value : 0
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(StatLabel, {
        children: label
      })]
    });
  };
  ...
  const renderBarChart = (items = []) => {
    ...
    if (!items.length || maxValue === 0) {
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(ChartEmptyState, {
        children: "No hi ha dades suficients."
      });
    }
